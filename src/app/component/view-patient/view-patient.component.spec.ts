...
const diseasesList = [{ name: "fever" }, { name: "cold" }];
...
const bookAppointment = {
  ...
  registeredTime:
    "Date(Thu Sep 19 2019 12:38:28 GMT+0530 (India Standard Time))",
};
...
describe("ViewPatientComponent", () => {
  ...
  it("Book Appointment & Scheduled Appointment should be enabled by default", fakeAsync(() => {
    expect(
      fixture.debugElement.nativeElement.querySelector("#book-appointment")
        .disabled
    ).toBeFalsy();
    expect(
      fixture.debugElement.nativeElement.querySelector("#Scheduled-appointment")
        .disabled
    ).toBeFalsy();
  ...
  it('"Book Appointment" button should be disabled after clicking on that button', fakeAsync(() => {
    fixture.whenStable().then(() => {
      ...
      expect(
        fixture.nativeElement.querySelector("#form-container")
      ).toBeTruthy();
      expect(
  ...
  it('should call scheduleAppointment method for valid form input"', fakeAsync(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      component.appointmentForm.controls["tentativeDate"].setValue(
        "2018-12-25"
      );
      fixture.detectChanges();
